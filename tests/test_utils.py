...
class TestUtils:
    @pytest.fixture
    def base_url(self):
        return "http://numorian.com/path/page.html"

    @pytest.fixture
    def base_url_https(self):
        return "https://numorian.com:8080/path/page.html"
    ...
    def test_protocol_relative_url(self, base_url, base_url_https):
        href = "//cdn.numorian.com/lib.js"
        expected = "http://cdn.numorian.com/lib.js"
        assert fix_relative_link(href, base_url) == expected

        href = "//cdn.numorian.com/lib.js"
        expected = "https://cdn.numorian.com/lib.js"
        assert fix_relative_link(href, base_url_https) == expected

    def test_leading_slash(self, base_url):
        href = "/images/logo.png"
        expected = "http://numorian.com/images/logo.png"
        assert fix_relative_link(href, base_url) == expected

    def test_dot_slash(self, base_url):
        href = "./about.html"
        expected = "http://numorian.com/path/about.html"
        assert fix_relative_link(href, base_url) == expected

    def test_double_dot_slash(self, base_url):
        href = "../contact.html"
        expected = "http://numorian.com/contact.html"
        assert fix_relative_link(href, base_url) == expected

    def test_relative_filename(self, base_url):
        href = "file.txt"
        expected = "http://numorian.com/path/file.txt"
        assert fix_relative_link(href, base_url) == expected
